...
import { isTunnelMode } from '/js/state.js';
import { reloadGeojson, refreshLayerStyles } from '/js/map/layer_SOL.js';
import { updateLegend } from '/js/map/legend.js';
import { DEFAULT_COLOR_MODE } from '/js/config/colorModes.js';
import { setCurrentColorMode } from '/js/state.js';

import { getOpSubMode, setOpSubMode, setOpCurrentColorMode } from '/js/state.js';
