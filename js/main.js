...
import { initXMLLoader } from '../data/xml_loader.js';
import { showLoading, hideLoading, updateLoadingMessage } from '/js/ui/loadingOverlay.js';
// ★ 追加
...
document.addEventListener('DOMContentLoaded', async () => {  
    ...
    try {
        await initXMLLoader('/data/RINF_Sp92v2.xml');  
