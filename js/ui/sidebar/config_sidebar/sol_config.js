...
export const PARAM_STRUCTURE = [
    ...
    },
    {
        ...
        sections: [
            ...
            {
                id: 'ECS_ElectrifiedOCL',
                label: 'ElectrifiedOCL',
                description: `
                    Paramètres d’alimentation électrique applicables aux lignes électrifiées par caténaire.
                `,
                paramIds: [
                    'ECS_SystemType',
                    'ECS_VoltFreq',
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                label: 'NOETCS',
                description: `
                    Paramètres applicables aux voies ne disposant pas d’un système ETCS.
                `,
                paramIds: [
                    'CPE_Level',
                    'CPE_Baseline'
            ...
            {
                id: 'CTD_TRACKCIRCUIT',
                label: 'CTD - Control-Command Train Detection (Track circuit)',
                set: 'trackcircuit',
                description: `
                    Paramètres relatifs aux systèmes de détection des trains par circuits de voie.
                `,
                paramIds: [
                    'CTD_DetectionSystem',
                    'CTD_TCCheck',
            ...
            {
                id: 'CTD_LOOP',
                label: 'CTD - Control-Command Train Detection (Loop)',
                set: 'loop',
                description: `
                    Paramètres relatifs aux systèmes de détection des trains par boucles.
                `,
                paramIds: [
                    'CTD_DetectionSystem',
                    'CTD_TCCheck',
            ...
            {
                id: 'CTD_WHEEL',
                label: 'CTD - Control-Command Train Detection (Wheel)',
                set: 'Wheeldetector',
                description: `
                    Paramètres relatifs aux systèmes de détection des trains par détecteurs de roues.
                `,
                paramIds: [
                    'CTD_DetectionSystem',
                    'CTD_TCCheck',
