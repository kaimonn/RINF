...
export function extractConceptValues(properties, paramId, set = null) {
...
function collectParamValues(paramsList, paramId, set = null) {
...
export function buildConceptMode(paramId, config = {}) {
    ...
    const paramSet = config.set ?? null;
    ...
    const extractValues =
        typeof config.extractValues === 'function'
            ...
            : (props) => (
                scope === 'OP'
                    ? extractOpConceptValues(
                        props,
                        paramId,
                        paramSet
                    )
                    : extractConceptValues(
                        props,
                        paramId,
                        paramSet
                    )
